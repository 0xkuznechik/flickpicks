...
export const BALLOT_CATEGORIES: BallotCategory[] = [
...

  {
    ...
    nominees: [
      { name: "Butterfly", odds: -140 },
      { name: "Forevergreen", odds: 650 },
      { name: "Retirement Plan", odds: 750 },
